...
int gdbDetermineMonitorCommand(char *, int &);
void gdbUnknownCmd(void);
void gdbUnknownOpt(void);
void gdbAmbiguousCmd(void);
void gdbRangeSteppingOption(char);
void gdbPseudoOption(byte);
void gdbStoreReqMcu(char[]);
void gdbAtExit(char);
void gdbBreakOption(char);
void gdbHelp(void);
void gdbInfo(void);
...
void getInstructionAtWAddr(unsigned int, unsigned int &, unsigned int &); 
...
byte gdbStep();
byte gdbContinue();
byte gdbRangeStep(const byte*);
unsigned int analyzeRange(void);
unsigned int condBranchDestination(unsigned int, unsigned int);
unsigned int relativeBranchDestination(unsigned int, unsigned int);
boolean relativeBranchInstr(unsigned int);
boolean condBranchInstr(unsigned int);
boolean skipInstr(unsigned int);
boolean indirBranchInstr(unsigned int);
boolean retxInstr(unsigned int);
boolean branchInstr(unsigned int);
