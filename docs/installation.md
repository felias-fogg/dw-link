...
```
These package indices make [*MicroCore*](https://github.com/MCUdude/MicroCore) (ATtin13(a)), [*TinyCore*](https://github.com/MCUdude/TinyCore) (all other classic ATtinys),  and [*MiniCore*](https://github.com/MCUdude/MiniCore) (ATmegaX8) known to the IDE. These cores are all debug-enabled.
